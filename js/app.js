(() => {
    ...
    if (document.querySelector(".steps-slider")) new swiper_core_Swiper(".steps-slider", {
    ...
    if (document.querySelector(".participants-slider")) new swiper_core_Swiper(".participants-slider", {
